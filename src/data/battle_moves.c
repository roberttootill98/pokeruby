...
/*
new field -- isPhysical
0 special
1 physical
2 other -- includes status
*/
const struct BattleMove gBattleMoves[] = {
    ...
    [MOVE_CLOSE_COMBAT] = {
        .effect = EFFECT_DEFENSE_DOWN_SPECIAL_DEFENSE_DOWN,
        .power = 120,
        .type = TYPE_FIGHTING,
        .accuracy = 100,
        .pp = 5,
    ...
    [MOVE_DEFOG] = {
        .effect = EFFECT_HIT, // placeholder, effect_move
        .power = 0,
        .type = TYPE_FLYING,
        .accuracy = 100,
        .pp = 15,
    ...
    [MOVE_FEINT] = {
        .effect = EFFECT_HIT, // placeholder, effect_feint
        .power = 30,
        .type = TYPE_NORMAL,
        .accuracy = 100,
        .pp = 10,
    ...
    [MOVE_FIRE_FANG] = {
        .effect = EFFECT_HIT, // placeholder, effect_fire_fang
        .power = 65,
        .type = TYPE_FIRE,
        .accuracy = 95,
        .pp = 15,
    ...
    [MOVE_FLARE_BLITZ] = {
        .effect = EFFECT_HIT, // placeholder effect_flare_blitz
        .power = 120,
        .type = TYPE_FIRE,
        .accuracy = 100,
        .pp = 15,
    ...
    [MOVE_GRASS_KNOT] = {
        .effect = EFFECT_HIT, // placeholder, effect_grass_knot
        .power = 0,
        .type = TYPE_GRASS,
        .accuracy = 100,
        .pp = 20,
    ...
    [MOVE_GUARD_SWAP] = {
        .effect = EFFECT_HIT, // placeholder, effect_guard_swap
        .power = 0,
        .type = TYPE_PSYCHIC,
        .accuracy = 0,
        .pp = 10,
    ...
    [MOVE_GYRO_BALL] = {
        .effect = EFFECT_HIT, // placeholder, effect_gyro_ball
        .power = 0,
        .type = TYPE_STEEL,
        .accuracy = 100,
        .pp = 5,
    ...
    [MOVE_HAMMER_ARM] = {
        .effect = EFFECT_HIT, // placeholder, effect_self_speed_down_hit
        .power = 100,
        .type = TYPE_FIGHTING,
        .accuracy = 90,
        .pp = 10,
    ...
    [MOVE_HEAD_SMASH] = {
        .effect = EFFECT_HIT, // placeholder, effect_recoil_half
        .power = 150,
        .type = TYPE_ROCK,
        .accuracy = 80,
        .pp = 5,
    ...
    [MOVE_HEART_SWAP] = {
        .effect = EFFECT_HIT, // placeholder, effect_heart_swap
        .power = 0,
        .type = TYPE_PSYCHIC,
        .accuracy = 0,
        .pp = 10,
    ...
    [MOVE_ICE_FANG] = {
        .effect = EFFECT_HIT, // placeholde, effect_ice_fang
        .power = 65,
        .type = TYPE_ICE,
        .accuracy = 95,
        .pp = 15,
    ...
    [MOVE_LUCKY_CHANT] = {
        .effect = EFFECT_HIT, // placeholder, effect_lucky_chant
        .power = 0,
        .type = TYPE_NORMAL,
        .accuracy = 0,
        .pp = 30,
    ...
    [MOVE_NASTY_PLOT] = {
        .effect = EFFECT_HIT, // placeholder, effect_nasty_plot
        .power = 0,
        .type = TYPE_DARK,
        .accuracy = 0,
        .pp = 20,
    ...
    [MOVE_POWER_TRICK] = {
        .effect = EFFECT_HIT, // placeholder, effect_power_trick
        .power = 0,
        .type = TYPE_PSYCHIC,
        .accuracy = 0,
        .pp = 10,
    ...
    [MOVE_PSYCHO_SHIFT] = {
        .effect = EFFECT_HIT, // placeholder, effect_psycho_shift
        .power = 0,
        .type = TYPE_PSYCHIC,
        .accuracy = 100,
        .pp = 10,
    ...
    [MOVE_ROOST] = {
        .effect = EFFECT_HIT, // placeholder, effect_roost
        .power = 0,
        .type = TYPE_FLYING,
        .accuracy = 0,
        .pp = 10,
    ...
    [MOVE_STEALTH_ROCK] = {
        .effect = EFFECT_HIT, // placeholder, effect_stealth_rock
        .power = 0,
        .type = TYPE_ROCK,
        .accuracy = 0,
        .pp = 20,
    ...
    [MOVE_SUCKER_PUNCH] = {
        .effect = EFFECT_HIT, // placeholder, effect_sucker_punch
        .power = 70,
        .type = TYPE_DARK,
        .accuracy = 100,
        .pp = 20,
    ...
    [MOVE_SWITCHEROO] = {
        .effect = EFFECT_HIT, // placeholder, effect_switcheroo
        .power = 0,
        .type = TYPE_DARK,
        .accuracy = 100,
        .pp = 10,
    ...
    [MOVE_TAILWIND] = {
        .effect = EFFECT_HIT, // placeholder, effect_tailwind
        .power = 0,
        .type = TYPE_FLYING,
        .accuracy = 0,
        .pp = 15,
    ...
    [MOVE_THUNDER_FANG] = {
        .effect = EFFECT_HIT, // placeholder, effect_thunder_fang
        .power = 65,
        .type = TYPE_ELECTRIC,
        .accuracy = 95,
        .pp = 15,
    ...
    [MOVE_TOXIC_SPIKES] = {
        .effect = EFFECT_HIT, // placeholder, effect_toxic_spikes
        .power = 0,
        .type = TYPE_POISON,
        .accuracy = 95,
        .pp = 15,
    ...
    [MOVE_TRICK_ROOM] = {
        .effect = EFFECT_HIT, // placeholder, effect_trick_room
        .power = 0,
        .type = TYPE_PSYCHIC,
        .accuracy = 0,
        .pp = 5,
    ...
    [MOVE_TRUMP_CARD] = {
        .effect = EFFECT_HIT, // placeholder, effect_trump_card
        .power = 0,
        .type = TYPE_NORMAL,
        .accuracy = 0,
        .pp = 5,
    ...
    [MOVE_WAKE_UP_SLAP] = {
        .effect = EFFECT_HIT, // placeholder, effect_wake_up_slap
        .power = 70,
        .type = TYPE_FIGHTING,
        .accuracy = 100,
        .pp = 10,
    ...
    [MOVE_WORRY_SEED] = {
        .effect = EFFECT_HIT, // placeholder, effect_worry_seed
        .power = 0,
        .type = TYPE_GRASS,
        .accuracy = 100,
        .pp = 10,
